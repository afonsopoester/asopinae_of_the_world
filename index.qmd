...
Using data from the literature and museum specimens, we recorded 5030 records for 299 species of Asopinae and made them available in Roell et al 2025. We hope to further expand the database, as more species and records are described .

Here, you can check the species we compiled, and the number of records for each one.
There is also a plot showing how many species we compiled for each adminstrative regions (GADM, 2024, see Roell et al 2025). 
